    ...
    private void createNotification(String msg, Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder.setContentTitle(msg)  // required
                    .setSmallIcon(android.R.drawable.ic_popup_reminder).setContentText(context.getString(R.string.app_name)).setDefaults(Notification.DEFAULT_ALL).setAutoCancel(true).setTicker(msg).setVibrate(new long[]{100, 200, 300, 400, 500, 400, 300, 200, 400});
        } else {
            ...
            builder.setContentTitle(msg)                           // required
                    ...
                    .setDefaults(Notification.DEFAULT_ALL).setAutoCancel(true).setTicker(msg).setVibrate(new long[]{100, 200, 300, 400, 500, 400, 300, 200, 400}).setPriority(Notification.PRIORITY_HIGH);
